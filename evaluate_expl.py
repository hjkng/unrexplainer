...
pd.DataFrame({'model': ['n2', 'n3', 'knn', 'rw', 'rwr', 'tx', 'tage','unr'],
            ...
            'imp':[r1[1], r2[1], r3[1], r4[1], r5[1], tx[0], tage[1], r6[1]], 
            'PN':[r1[2], r2[2], r3[2], r4[2], r5[2], tx[0], tage[2], r6[2]], 
            'size':[r1[3], r2[3], r3[3], r4[3], r5[3], tx[0], tage[3], r6[3]]}).to_csv('./result/'+data_nm+'_'+str(args.model)+'_'+str(args.task)+'_eval.csv', index=False)
